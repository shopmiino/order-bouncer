...
public class LineItemExtrasConverterService : ILineItemExtrasConverterService
{
    ...
    public async Task<BaseDto> ConvertExtra(LineItem lineItem, IList<NoteAttribute[]> props, Func<NoteAttribute[], NoteAttribute[]?> noteGetter, int position = 0, int notePosition = 0, bool hasNoImage = false)
    {
